...
var _taskReducerMjs = require("../taskReducer.mjs");
var _taskReducerMjsDefault = parcelHelpers.interopDefault(_taskReducerMjs);
var _actionsMjs = require("../actions.mjs");
const store = (0, _redux.createStore)((0, _taskReducerMjsDefault.default));
store.getState();
...
const handleToggleTask = (taskId)=>{
    store.dispatch((0, _actionsMjs.toggleTask)(taskId));
};
...
addTaskForm.addEventListener("submit", function(event) {
    ...
    if (!taskName || !taskDetail) console.error("Please enter task name and task detail");
    const taskId = taskCounter++;
    store.dispatch((0, _actionsMjs.addTask)({
        id: taskId,
        name: taskName,
        details: taskDetail,
        completed: false
...
removeTaskBtn.addEventListener("click", function() {
    ...
    if (isNaN(removeTaskId)) alert("Invalid Id");
    store.dispatch((0, _actionsMjs.removeTask)(removeTaskId));
    document.getElementById("removeTaskId").value = "";
});
renderTasks();

},{"redux":"anWnS","../taskReducer.mjs":"9yEXY","../actions.mjs":"7oHf2","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"anWnS":[function(require,module,exports,__globalThis) {
...
},{}],"9yEXY":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _actionsMjs = require("./actions.mjs");
const initialState = {
...
const taskReducer = (state = initialState, action)=>{
    switch(action.type){
        ...
        case 0, _actionsMjs.REMOVE_TASK:
        ...
        case 0, _actionsMjs.TOGGLE_TASK:
            const toggledTask = state.tasks.map((task)=>task.id === action.payload ? {
                    ...task,
...
},{"./actions.mjs":"7oHf2","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"7oHf2":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "ADD_TASK", ()=>ADD_TASK);
parcelHelpers.export(exports, "REMOVE_TASK", ()=>REMOVE_TASK);
parcelHelpers.export(exports, "TOGGLE_TASK", ()=>TOGGLE_TASK);
parcelHelpers.export(exports, "addTask", ()=>addTask);
parcelHelpers.export(exports, "removeTask", ()=>removeTask);
parcelHelpers.export(exports, "toggleTask", ()=>toggleTask);
const ADD_TASK = "task/added";
const REMOVE_TASK = "task/removed";
const TOGGLE_TASK = "task/toggled";
const addTask = (task)=>({
        type: ADD_TASK,
        payload: task
    });
